...
import { createContext, type InputHTMLAttributes, type PropsWithChildren, useCallback, useContext, type RefObject } from 'react'
...
type UseSupabaseUploadReturn = {
  ...
  getInputProps: (props?: DropzoneInputProps) => InputHTMLAttributes<HTMLInputElement>
}
