...
export function GuestbookCard() {
  ...
  return (
    <BentoCard 
      colSpan={2} 
      rowSpan={1} 
      className="h-full min-h-[220px] flex flex-col justify-between bg-black/40 backdrop-blur-2xl text-white overflow-hidden shadow-lg hover:bg-black/50 transition-colors"
