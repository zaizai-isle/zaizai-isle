  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 grid-rows-2 w-full h-full p-0 gap-2 md:p-3 md:gap-4">
        ...
        >
          <div className="w-15 h-15 flex items-center justify-center rounded-full bg-white/20 backdrop-blur-md border border-white/20 text-gray-800 group-hover:bg-white/40 transition-colors">
